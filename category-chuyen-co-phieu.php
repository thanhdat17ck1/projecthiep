    ...
    <div class="promotions l-container">
        <div class="p-search__left">
            <section class="category-post">
                <!-- Get category -->
                <!-- Get post News Query -->
                <?php $getposts = new WP_query(); $getposts->query('post_status=publish&showposts=10&post_type=dien-dan&cat=25'); ?>
                ...
                <?php endwhile; else : ?> <p>Không có bài viết nào</p> <?php wp_reset_postdata(); ?>
                <?php endif; ?>
