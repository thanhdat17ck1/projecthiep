                ...
                P instanceof THREE.MeshPhongMaterial
                  ...
                  : P instanceof THREE.MeshDepthMaterial &&
                    ...
                    (Y.r =
                      ...
                      Y.b =
                        1 -
                        k(wa.positionScreen.z * wa.positionScreen.w, Wa, ab)),
                    (da.r =
                      da.g =
                      da.b =
                        1 -
                        k(hb.positionScreen.z * hb.positionScreen.w, Wa, ab)),
                    (la.r =
                      la.g =
                      la.b =
                        1 -
                        k(Bb.positionScreen.z * Bb.positionScreen.w, Wa, ab)),
                    (Fa = E(pa, Y, da, la)),
                    y(M, ca, qa, ha, Ma, Na),
                    G(M, ca, qa, ha, Ma, Na, 0, 0, 1, 0, 0, 1, Fa),
                    y(mb, Pa, ra, N, ta, ka),
  ...
  function g(a, b) {
    ...
    void 0 === c &&
      (m[a.index][b.index] =
        m[b.index][a.index] =
        c =
          e(new THREE.Vector3().addVectors(a, b).divideScalar(2)));
    return c;
  }
  function h(a, b, c) {
